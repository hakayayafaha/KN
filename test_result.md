...
metadata:
  created_by: "main_agent"
  version: "FASE-D-CLOSING"
  test_sequence: 235
  run_ui: true

test_plan:
  current_focus:
    - "D-US1 — MD membuat Permintaan Desain dari SO pelanggan, menugaskan desainer, tenggat 3 hari"
    - "D-US2 — desainer menyerahkan artwork; dokumen pindah ke Menunggu Keputusan & masuk antrean atasan"
    - "D-US3 — manajer minta revisi BER-ALASAN; desainer membaca alasannya di dokumen"
    - "D-US4 — manajer membuka Rapor Desainer; desainer membuka Rapor Saya (tanpa nama rekan)"
    - "Peran ke-7 designer: menu sempit, nol layar/panel mati, tak bisa memutuskan karyanya sendiri"
  stuck_tasks: []
  test_all: false
  test_priority: "high_first"
